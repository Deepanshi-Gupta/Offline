...
TRANSLATIONS = {
    ...
    "nav.character_profile": {"ar": "الملف الشخصي للشخصية", "en": "Character Profile"},
    ...
    # ---- character profile (2-video identity profile builder) ----
    "charprofile.subtitle": {
        "ar": "إنشاء ملف هوية للشخصية من مقطعي فيديو مرجعيَّين — أمامي وجانبي مثلاً.",
        "en": "Build a character identity profile from two reference videos — e.g. a front-facing and a turn/profile take.",
    },
    "charprofile.name.label": {"ar": "اسم الملف الشخصي", "en": "Profile name"},
    "charprofile.name.placeholder": {"ar": "مثال: عمر — أخذة أمامية", "en": "e.g. Omar — front take"},
    "charprofile.name.default": {"ar": "ملف شخصي بلا اسم", "en": "Untitled profile"},
    "charprofile.videos.title": {"ar": "مقطعا الفيديو المرجعيان", "en": "Reference Videos"},
    "charprofile.videos.hint": {
        "ar": "مطلوب فيديوهان على الأقل لتوليد الملف الشخصي — يمكن إضافة المزيد لتحسين تطابق الهوية.",
        "en": "At least 2 videos are required to generate the profile — add more for a stronger identity match.",
    },
    "charprofile.video.btn": {"ar": "اختيار الفيديو {n}…", "en": "Choose Video {n}…"},
    "charprofile.video.none": {"ar": "لم يتم اختيار فيديو.", "en": "No video selected."},
    "charprofile.video.selected": {"ar": "الفيديو: {name}", "en": "Video: {name}"},
    "charprofile.btn.add_video": {"ar": "+ إضافة فيديو", "en": "+ Add Video"},
    "charprofile.btn.remove_video": {"ar": "إزالة", "en": "Remove"},
    "charprofile.status.idle": {"ar": "بانتظار الفيديوهين", "en": "Waiting for videos"},
    "charprofile.status.processing": {"ar": "جارٍ إنشاء الملف الشخصي…", "en": "Building profile…"},
    "charprofile.status.complete": {"ar": "اكتمل", "en": "Complete"},
    "charprofile.processing_text": {"ar": "جارٍ التحليل عبر مقطعي الفيديو…", "en": "Analyzing across both videos…"},
    "charprofile.result.desc": {
        "ar": "تم إنشاء الملف الشخصي «{name}» من مقطعي الفيديو.",
        "en": "Profile \"{name}\" was generated from the two videos.",
    },
    "charprofile.btn.generate": {"ar": "▶ توليد الملف الشخصي", "en": "▶ Generate Profile"},
    "charprofile.btn.reset": {"ar": "↻ البدء من جديد", "en": "↻ Start Over"},
    ...
    "audio.mix_preview.generate_btn": {"ar": "▶ توليد معاينة المزيج", "en": "▶ Generate Mix Preview"},
    "audio.mix_preview.download_btn": {"ar": "⭳ تنزيل المزيج", "en": "⭳ Download Mix"},
    "audio.mix_preview.empty": {"ar": "أضف مقطعاً واحداً على الأقل إلى المزيج أولاً.", "en": "Add at least one clip to the mix first."},
    "audio.mix_preview.none": {"ar": "لم يتم توليد معاينة للمزيج بعد.", "en": "No mix preview generated yet."},
    "audio.mix_preview.ready": {"ar": "معاينة المزيج جاهزة — قيد التشغيل…", "en": "Mix preview ready — playing…"},
    ...
    "motion.reference.title": {"ar": "مدخلات مرجعية", "en": "Reference Inputs"},
    "motion.reference.image.btn": {"ar": "اختيار صورة مرجعية…", "en": "Choose Reference Image…"},
    "motion.reference.image.none": {"ar": "لم يتم اختيار صورة مرجعية.", "en": "No reference image selected."},
    "motion.reference.image.selected": {"ar": "الصورة المرجعية: {name}", "en": "Reference image: {name}"},
    "motion.reference.audio.btn": {"ar": "اختيار صوت مرجعي…", "en": "Choose Reference Audio…"},
    "motion.reference.audio.none": {"ar": "لم يتم اختيار صوت مرجعي.", "en": "No reference audio selected."},
    "motion.reference.audio.selected": {"ar": "الصوت المرجعي: {name}", "en": "Reference audio: {name}"},
    "motion.reference.clear": {"ar": "إزالة", "en": "Clear"},
    "motion.reference.profile.label": {"ar": "شخصية الملف الشخصي", "en": "Profile Character"},
    "motion.reference.profile.none": {"ar": "— بلا —", "en": "— None —"},
    "motion.reference.profile.hint": {
        "ar": "يربط هذا المشهد بحزمة شخصية محفوظة للحفاظ على ثبات الهوية أثناء الحركة.",
        "en": "Links this scene to a saved character pack for identity-consistent motion.",
    },
    "motion.reference.profile.empty_hint": {
        "ar": "لا توجد حزم شخصيات بعد — أضِف شخصية من شاشة حزم الشخصيات لتظهر هنا.",
        "en": "No character packs yet — add one from the Character Packs screen to see it here.",
    },
